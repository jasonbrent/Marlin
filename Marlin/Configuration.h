...
#define STRING_CONFIG_H_AUTHOR "ljason: 12/10/2017" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "TimeSink3D"
...
// PID Autotune E3Dv6 / M303 S215 C10 WITH fans
 #define DEFAULT_Kp 16.59
 #define DEFAULT_Ki   0.68
 #define DEFAULT_Kd  100.56
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION 237
  #define FRONT_PROBE_BED_POSITION 12
  #define BACK_PROBE_BED_POSITION 288
...
#define LEVEL_BED_CORNERS // XXX: Can probably remove this from my build soon due to the fixed bed.
...
#define DEFAULT_NOMINAL_FILAMENT_DIA 1.75   // (mm) Diameter of the filament generally used (3.0 or 1.75mm), also used in the slicer. Used to validate sensor reading.
  ...
  #define MEASURED_UPPER_LIMIT         1.80 // (mm) Upper limit used to validate sensor reading
